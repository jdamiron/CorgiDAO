...
contract sCORGI is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("Staked Corgi", "sCORGI", 9) ERC20Permit() {
  ...
  /**
        @notice increases sCORGI supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sCORGI
