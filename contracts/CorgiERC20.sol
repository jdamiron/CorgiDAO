...
library EnumerableSet {
  ...
  /**
   *  Inserts new value by moving existing value at provided index to end of array and setting provided 
      value at provided index
   */
  function _insert(
    Set storage set_,
    uint256 index_,
...
contract CORGIERC20Token is ERC20Permit, VaultOwned {
  using SafeMath for uint256;

  constructor() ERC20("Corgi DAO", "CORGI", 9) {}
